...
HEADERS += src/activemasternode.h \
           ...
           src/qt/askpassMINTDasedialog.h \
...
FORMS += src/qt/forms/addressbookpage.ui \
         src/qt/forms/askpassMINTDasedialog.ui \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/qt/askpassMINTDasedialog.cpp \
...
RESOURCES += src/qt/mintd.qrc src/qt/mintd_locale.qrc

TRANSLATIONS += src/qt/locale/mintd_bg.ts \
                src/qt/locale/mintd_de.ts \
                src/qt/locale/mintd_en.ts \
                src/qt/locale/mintd_es.ts \
                src/qt/locale/mintd_fi.ts \
                src/qt/locale/mintd_fr.ts \
                src/qt/locale/mintd_it.ts \
                src/qt/locale/mintd_ja.ts \
                src/qt/locale/mintd_pl.ts \
                src/qt/locale/mintd_pt.ts \
                src/qt/locale/mintd_ru.ts \
                src/qt/locale/mintd_sk.ts \
                src/qt/locale/mintd_sv.ts \
                src/qt/locale/mintd_vi.ts \
                src/qt/locale/mintd_zh_CN.ts \
                src/qt/locale/mintd_zh_TW.ts
