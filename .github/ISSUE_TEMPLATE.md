...
This issue tracker is only for technical issues related to MINTD Core.
General MINTD questions and/or support requests and are best directed to the [MINTD Discord](https://discord.gg/MWUat6d).
...
### What version of MINTD Core are you using?
