Contributing to MINTD Core
============================

The MINTD Core project operates an open contributor model where anyone is
...
The following applies to code changes to the MINTD Core project, and is not to be
confused with overall MINTD Network Protocol consensus changes.

Whether a pull request is merged into MINTD Core rests with the project merge
...
Patches that change MINTD consensus rules are considerably more involved than
...
Where a patch set proposes to change the MINTD consensus, it must have been
...
The project leader is the release manager for each MINTD Core release.
