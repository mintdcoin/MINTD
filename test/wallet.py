...
#   c) node1 mines 32 blocks, so now node 0 has 60001MINTD, node 1 has 4250MINTD, node2 has none.
#   d) node0 sends 601 MINTD to node2, in two transactions (301 MINTD, then 300 MINTD).
