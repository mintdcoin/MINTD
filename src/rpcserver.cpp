...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* MINTD features */
        {"mintd", "masternode", &masternode, true, true, false},
        {"mintd", "listmasternodes", &listmasternodes, true, true, false},
        {"mintd", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"mintd", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"mintd", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"mintd", "getmasternodecount", &getmasternodecount, true, true, false},
        {"mintd", "masternodeconnect", &masternodeconnect, true, true, false},
        {"mintd", "masternodecurrent", &masternodecurrent, true, true, false},
        {"mintd", "masternodedebug", &masternodedebug, true, true, false},
        {"mintd", "startmasternode", &startmasternode, true, true, false},
        {"mintd", "createmasternodekey", &createmasternodekey, true, true, false},
        {"mintd", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"mintd", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"mintd", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"mintd", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"mintd", "getmasternodescores", &getmasternodescores, true, true, false},
        {"mintd", "mnbudget", &mnbudget, true, true, false},
        {"mintd", "preparebudget", &preparebudget, true, true, false},
        {"mintd", "submitbudget", &submitbudget, true, true, false},
        {"mintd", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"mintd", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"mintd", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"mintd", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"mintd", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"mintd", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"mintd", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"mintd", "checkbudgets", &checkbudgets, true, true, false},
        {"mintd", "mnsync", &mnsync, true, true, false},
        {"mintd", "spork", &spork, true, true, false},
        {"mintd", "getpoolinfo", &getpoolinfo, true, true, false},
        {"mintd", "makekeypair", &makekeypair, true, true, false},
#ifdef ENABLE_WALLET
        /* Wallet */
        ...
        {"zerocoin", "getzMINTDseed", &getzMINTDseed, false, false, true},
        {"zerocoin", "setzMINTDseed", &setzMINTDseed, false, false, true}
...
{
    return "> mintd-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:19992/\n";
}
