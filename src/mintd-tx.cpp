...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("MINTD Core mintd-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  mintd-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mintd transaction") + "\n" +
                               "  mintd-tx [options] -create [commands]   " + _("Create hex-encoded mintd transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded mintd transaction
