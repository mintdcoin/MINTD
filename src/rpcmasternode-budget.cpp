...
UniValue mnbudget(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp ||
        ...
        throw runtime_error(
            ...
            "  vote-many          - Vote on a MINTD initiative\n"
            "  vote-alias         - Vote on a MINTD initiative\n"
            "  vote               - Vote on a MINTD initiative/budget\n"
...
UniValue preparebudget(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 6)
        throw runtime_error(
            "preparebudget \"proposal-name\" \"url\" payment-count block-start \"mintd-address\" monthly-payment\n"
            ...
            "5. \"mintd-address\":   (string, required) MINTD address to send payments to\n"
            "6. monthly-payment:  (numeric, required) Monthly payment amount\n"

            "\nResult:\n"
            "\"xxxx\"       (string) proposal fee hash (if successful) or error message (if failed)\n"
            "\nExamples:\n" +
            HelpExampleCli("preparebudget", "\"test-proposal\" \"https://forum.mintd.net/t/test-proposal\" 2 820800 \"MTp7R6SowUCxAzRp1rWhnavzR7iR4mZMZ7\" 500") +
            HelpExampleRpc("preparebudget", "\"test-proposal\" \"https://forum.mintd.net/t/test-proposal\" 2 820800 \"MTp7R6SowUCxAzRp1rWhnavzR7iR4mZMZ7\" 500"));
...
UniValue submitbudget(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 7)
        throw runtime_error(
            "submitbudget \"proposal-name\" \"url\" payment-count block-start \"mintd-address\" monthly-payment \"fee-tx\"\n"
            ...
            "\nExamples:\n" +
            HelpExampleCli("submitbudget", "\"test-proposal\" \"https://forum.mintd.net/t/test-proposal\" 2 820800 \"MTp7R6SowUCxAzRp1rWhnavzR7iR4mZMZ7\" 500") +
            HelpExampleRpc("submitbudget", "\"test-proposal\" \"https://forum.mintd.net/t/test-proposal\" 2 820800 \"MTp7R6SowUCxAzRp1rWhnavzR7iR4mZMZ7\" 500"));
...
UniValue getbudgetprojection(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "    \"PaymentAddress\": \"xxxx\",     (string) MINTD address of payment\n"
...
UniValue mnfinalbudget(const UniValue& params, bool fHelp)
{
    ...
    if (strCommand == "show") {
        ...
        BOOST_FOREACH (CFinalizedBudget* finalizedBudget, winningFbs) {
            ...
            if (finalizedBudget->GetBlockStart() < (chainActive.Tip()->nHeight - GetBudgetPaymentCycleBlocks()))
                continue;
