                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzMINTDPathCustom = GetArg("-zMINTDbackuppath", "");
    ...
    if(!strzMINTDPathCustom.empty()) {
        ui->wallet_customzMINTDbackuppath->setText(QString::fromStdString(strzMINTDPathCustom));
        ui->wallet_customzMINTDbackuppath_label->setVisible(true);
        ui->wallet_customzMINTDbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzMINTDPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the MINTD RPC console.") + "<br>" +
