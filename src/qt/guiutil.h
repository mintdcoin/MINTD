...
/** Utility functions used by the MINTD Qt UI.
 */
namespace GUIUtil
{
...
// Render MINTD addresses in monospace font
...
// Parse "mintd:" URI into recipient object, return true on successful parsing
