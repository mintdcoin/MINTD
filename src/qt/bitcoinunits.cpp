...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(MINTD);
    unitlist.append(mMINTD);
    unitlist.append(uMINTD);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case MINTD:
        return QString("mintd");
    case mMINTD:
        return QString("mmintd");
    case uMINTD:
        return QString::fromUtf8("umintd");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case mMINTD:
            return QString("mMINTD");
        case uMINTD:
            return QString::fromUtf8("μMINTD");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case MINTD:
            return QString("tMINTD");
        case mMINTD:
            return QString("mtMINTD");
        case uMINTD:
            return QString::fromUtf8("μtMINTD");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case MINTD:
            return QString("MINTD");
        case mMINTD:
            return QString("Milli-MINTD (1 / 1" THIN_SP_UTF8 "000)");
        case uMINTD:
            return QString("Micro-MINTD (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case MINTD:
            return QString("TestMINTDs");
        case mMINTD:
            return QString("Milli-TestMINTD (1 / 1" THIN_SP_UTF8 "000)");
        case uMINTD:
            return QString("Micro-TestMINTD (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
