...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText = tr("MINTD Core");
    ...
    QString copyrightTextMINTD = QChar(0xA9) + QString(tr(" 2019 The MINTD Core developers"));
   ...
   // pixmap = pixmap.scaled(QSize(400,400), Qt::KeepAspectRatio,Qt::SmoothTransformation);
    ...
    pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 48, copyrightTextMINTD);
