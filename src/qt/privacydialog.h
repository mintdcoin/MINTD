...
public:
    ...
    void setZMINTDControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzMINTD_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzMINTD_clicked();
    void on_pushButtonZMINTDControl_clicked();
