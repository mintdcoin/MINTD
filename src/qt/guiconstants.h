...
/* MINTD GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "MINTD"
#define QAPP_ORG_DOMAIN "mintd.net"
#define QAPP_APP_NAME_DEFAULT "MINTD-Qt"
#define QAPP_APP_NAME_TESTNET "MINTD-Qt-Testnet"
