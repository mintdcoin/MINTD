                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("MINTD Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a MINTD address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and mintd: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zMINTD"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About MINTD Core"), this);
    aboutAction->setStatusTip(tr("Show information about MINTD Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for MINTD"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MINTD addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MINTD addresses"));
    ...
    openAction->setStatusTip(tr("Open a MINTD: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the MINTD Core help message to get a list with possible MINTD command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("MINTD Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MINTD network", "", count));
}
...
{
    QString strTitle = tr("MINTD Core"); // default title
