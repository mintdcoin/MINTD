 ...
 */
    ...
    typeWidget->addItem(tr("Received MINTD from zMINTD"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zMINTD"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zMINTD));
